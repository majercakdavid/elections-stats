...
export class Initial1556984324824 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "forecast" ("version" integer NOT NULL, "percentage" numeric(4,1) NOT NULL, "valid" boolean NOT NULL DEFAULT true, "userForecastId" uuid NOT NULL, "partyId" character varying NOT NULL, CONSTRAINT "PK_539a96a71510995ea41ef9f1c29" PRIMARY KEY ("version", "userForecastId", "partyId"))`);
